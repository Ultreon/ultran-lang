...
import com.ultreon.ultranlangold.ast.*
import com.ultreon.ultranlangold.token.TokenType
...
class Interpreter(val tree: Program?) : NodeVisitor() {
    ...
    @Visit(com.ultreon.ultranlangold.ast.String::class)
    fun visitString(node: com.ultreon.ultranlangold.ast.String): Any? {
        return node.value
    }
